                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <div>
                                    Preço de Venda:
                                    <input type="text" name="precoVenda" value="<?php echo $obj==NULL?"":$obj->getPrecoVenda(); ?>" id="precoVenda" class="form-control mb-2"/>
                                </div>
                                <div>
                                    Preço de Produção:
                                    <input type="text" name="precoProducao" value="<?php echo $obj==NULL?"":$obj->getPrecoProducao(); ?>" id="precoProducao" class="form-control mb-2"/>
                                </div>
                                <div>
                                    Quantidade Em Estoque:
                                    <input type="text" name="qtdEstoque" value="<?php echo $obj==NULL?"":$obj->getQtdEstoque(); ?>" id="qtdEstoque" class="form-control mb-2"/>
                                </div>
                                <div>
